...
class Button extends BaseBuilder {
    ...
    loadFrom(msg) {
        ...
        this._body = interactiveMessage.body?.text || '';
        this._footer = interactiveMessage.footer?.text || '';
        this._contextInfo = interactiveMessage.contextInfo || {};
...
class ButtonV2 extends BaseBuilder {
    ...
    loadFrom(msg) {
        ...
        this._body = buttonsMessage.contentText || '';
        this._footer = buttonsMessage.footerText || '';
        this._contextInfo = buttonsMessage.contextInfo || {};
        this._extraPayload = extraPayload;
        this._buttons = Array.isArray(buttonsMessage.buttons) ? [...buttonsMessage.buttons] : [];
...
class Carousel extends BaseBuilder {
    ...
    loadFrom(msg) {
        ...
        this._contextInfo = interactiveMessage.contextInfo || {};
        this._extraPayload = extraPayload;
        this._cards = Array.isArray(interactiveMessage.carouselMessage?.cards)
